...
class SearchViewTestCase(TestCase):
    ...
    @patch('bagtrekkin.views.search.SearchForm.search', side_effect=Luggage.DoesNotExist)
    @patch('bagtrekkin.views.search.SearchForm.is_valid', return_value=True)
    ...
    @patch('bagtrekkin.views.search.SearchForm.search', side_effect=Log.DoesNotExist)
    @patch('bagtrekkin.views.search.SearchForm.is_valid', return_value=True)
    ...
    @patch('bagtrekkin.views.search.SearchForm.search', side_effect=Passenger.DoesNotExist)
    @patch('bagtrekkin.views.search.SearchForm.is_valid', return_value=True)
